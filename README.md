...
# 6.23
1、今天完成了哪些任务？<br/>
今天把实训以来所有的课程都复习了，加深了对大数据框架的了解<br/>
2、今天遇到了哪些问题? <br/>
其实今天老师提问的许多问题，自己有部分并不能很好的回答<br/>
3、您又是如何解决这些问题的? <br/>
今天老师也发了课堂PPT，下周要考试，这几天好好搞懂概念<br/>
# 6.24
1、今天完成了哪些任务？<br/>
今天做了部分数据治理大作业，并复习了数据的额储存<br/>
2、今天遇到了哪些问题? <br/>
认真看后发现，S3的内容还是有些不理解，关于S3的高效储存<br/>
3、您又是如何解决这些问题的? <br/>
问了同学，发现大家都有这样的疑惑，暂时没有得到很好地解决<br/>
# 6.25
1、今天完成了哪些任务？<br/>
今天做了继续做了部分大作业，同时复习了离线计算和实时计算<br/>
2、今天遇到了哪些问题? <br/>
暂时没有<br/>
3、您又是如何解决这些问题的? <br/>
暂时没有<br/>
# 6.26
1、今天完成了哪些任务？<br/>
今天做了继续做了部分大作业，同时复习了人工智能与数据治理<br/>
2、今天遇到了哪些问题? <br/>
数据仓库物理模型不太确定<br/>
3、您又是如何解决这些问题的? <br/>
上网查资料了解了数仓物理模型的设计<br/>
# 6.27
1、今天完成了哪些任务？<br/>
今天做了完成了全部大作业，同时过了一遍全部ppt<br/>
2、今天遇到了哪些问题? <br/>
SQL语句进行查询的时候，timestamp类型提取月份老是失败，to_date(), to_char()都试过了<br/>
3、您又是如何解决这些问题的? <br/>
后来查了原因，原因是引号的问题，格式字段要用单引号，双引号则出问题<br/>
